...
//		棋盤初始化
		...
		infCheckerboard[4][4] = 2;
//		infCheckerboard[][] = ;
		infCheckerboard[4][2] = 2;
		infCheckerboard[3][2] = 2;
		infCheckerboard[2][3] = 2;
		infCheckerboard[2][2] = 2;
		infCheckerboard[2][4] = 2;
//		初始化物件
		checkerboard = new Checkerboard(CELL_SIZE, infCheckerboard); //JPanel
